...
def after_install():
	frappe.db.set_default('desktop:home_page', '')
        ...
        system("cp " + path.join(FBENCH, "sites/assets/angel/images/angel_logo.svg ") + " " + path.join(FBENCH, "sites/assets/erpnext/images/erp-icon.svg"))
        system("cp " + path.join(FBENCH, "sites/assets/angel/images/favicon16.png ") + " " + path.join(FBENCH, "sites/assets/erpnext/images/favicon.png"))
        system("cp " + path.join(FBENCH, "sites/assets/angel/images/splash-1.png ") + " " + path.join(FBENCH, "sites/assets/erpnext/images/splash.png"))
        ...
        system("cp " + path.join(APPS, "frappe/frappe/public/js/frappe/ui/toolbar/navbar.html") + " " + path.join(APPS, "frappe/frappe/public/js/frappe/ui/toolbar/navbar.html-bkk") )
