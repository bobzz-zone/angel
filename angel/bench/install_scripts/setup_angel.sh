...
install_bench() {
	#run_cmd sudo su $FRAPPE_USER -c "cd /home/$FRAPPE_USER && git clone https://github.com/frappe/bench --branch $BENCH_BRANCH bench-repo"
        run_cmd sudo su $FRAPPE_USER -c "mkdir /home/$FRAPPE_USER/bench-repo && cp -r /home/$FRAPPE_USER/angel/angel/bench/* /home/$FRAPPE_USER/bench-repo"
...
setup_bench() {
	echo Installing frappe-bench
        run_cmd sudo su $FRAPPE_USER -c "mkdir /home/$FRAPPE_USER/frappe && cp -r /home/$FRAPPE_USER/angel/angel/frappe/* /home/$FRAPPE_USER/frappe"
        run_cmd sudo su $FRAPPE_USER -c "mkdir /home/$FRAPPE_USER/erpnext && cp -r /home/$FRAPPE_USER/angel/angel/erpnext/* /home/$FRAPPE_USER/erpnext"
	...
	#fi
        echo "executing this command cd /home/$FRAPPE_USER && bench init frappe-bench --frappe-branch $FRAPPE_BRANCH --frappe-path /home/$FRAPPE_USER/frappe"
